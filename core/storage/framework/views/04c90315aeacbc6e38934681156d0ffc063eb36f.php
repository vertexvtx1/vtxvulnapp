<?php $__env->startSection('panel'); ?>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary cuModalBtn"
                                                    data-resource="<?php echo e($brand); ?>" data-modal_title="<?php echo app('translator')->get('Edit Brand'); ?>"
                                                    data-has_status="1">
                                                    <i class="la la-pencil"></i><?php echo app('translator')->get('Edit'); ?>
                                                </button>
                                                <?php $hasPermission = App\Models\Role::hasPermission('admin.product.brand.delete')  ? 1 : 0;
            if($hasPermission == 1): ?>
                                                    <button type="button"
                                                        class="btn btn-sm btn-outline-danger <?php if($brand->products_count): ?> disabled <?php endif; ?> confirmationBtn"
                                                        data-question="<?php echo app('translator')->get('Are you sure to delete this brand?'); ?>"
                                                        data-action="<?php echo e(route('admin.product.brand.delete', $brand->id)); ?>">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><span class="type"></span> <span><?php echo app('translator')->get('Add Brand'); ?></span></h5>
                ...
                <form action="<?php echo e(route('admin.product.brand.store')); ?>" method="POST">
                    ...
                    <?php $hasPermission = App\Models\Role::hasPermission('admin.product.brand.store')  ? 1 : 0;
            if($hasPermission == 1): ?>
    ...
    <div class="modal fade" id="importModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><?php echo app('translator')->get('Import Brand'); ?></h4>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <i class="la la-times" aria-hidden="true"></i>
                    </button>
                </div>
                <form method="post" action="<?php echo e(route('admin.product.brand.import')); ?>" id="importForm"
                        ...
                        <div class="form-group">
                            ...
                            <div class="mt-1">
                                ...
                                <small>
                                    ...
                                    <a href="<?php echo e(asset('assets/files/sample/brand.csv')); ?>" title="<?php echo app('translator')->get('Download csv file'); ?>"
...
<?php endif; ?>
    <?php $hasPermission = App\Models\Role::hasPermission('admin.product.brand.store')  ? 1 : 0;
            if($hasPermission == 1): ?>
        <button type="button" class="btn btn-sm btn-outline--primary cuModalBtn" data-modal_title="<?php echo app('translator')->get('Add New Brand'); ?>">
            <i class="las la-plus"></i><?php echo app('translator')->get('Add New'); ?>
        </button>
    <?php endif ?>
    <?php $hasPermission = App\Models\Role::hasPermission('admin.product.brand.import')  ? 1 : 0;
            if($hasPermission == 1): ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kenziy/Documents/vertex/vulnApps/core/resources/views/admin/brand/index.blade.php ENDPATH**/ ?>